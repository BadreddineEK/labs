"""Exporte le carrousel en images carrées (1080x1080, rendu x2) + un PDF concaténé.

Rend share/carousel.html via un navigateur headless (Playwright).
...
def _launch(p):
    """Sur poste d'entreprise, le chromium téléchargé peut être bloqué (spawn UNKNOWN).
    On tente d'abord Edge puis Chrome du système, puis le chromium de Playwright."""
